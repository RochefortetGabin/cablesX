...
if(document.location.href.indexOf("/res/") != -1){
    ...
    G.subject = G.subject ? G.subject.textContent : document.getElementsByClassName("post op")[0].firstChild.nextSibling.innerHTML.replace("<br>", " // ").replace(/<[^>]*>/g, "").substring(0, 40) + "...";
    quotes();
