...
if(document.location.href.indexOf("/res/") != -1){
    ...
    G.subject = G.subject ? G.subject.innerHTML : document.getElementsByClassName("post op")[0].firstChild.nextSibling.innerHTML;
    var i = G.subject.indexOf("<br>");
    if(i > 0 && i < 40){
        G.subject = G.subject.substring(0, i);   
    } else {
        G.subject = G.subject.substring(0,40).replace("<br>", "//");
    }
    quotes();
